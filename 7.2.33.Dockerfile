# Dockerfile
# docker build -f 7.2.33.Dockerfile . -t php:7.2.33

# 使用 7.2.33-fpm-alpine3.12 作为基础镜像
FROM php:7.2.33-fpm-alpine3.12 as builder
LABEL MAINTAINER="0xAiKang <aikangtongxue@gmail.com>"
LABEL description="PHP 镜像，版本为 7.2，支持 CLI、CGI、FPM 模式"
